 ...
 */
public class Search_by_IMEI extends javax.swing.JFrame {

    /**
     * Creates new form Search_by_IMEI
     */
    public Search_by_IMEI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        logo_label.setText("SEARCH BY IMEI");
        ...
        bg_panel1.add(logo_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 40, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/icons8_search_70px.png"))); // NOI18N
        bg_panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 20, -1, -1));
...
//            java.util.logging.Logger.getLogger(Search_by_IMEI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Search_by_IMEI().setVisible(true);
//            }
//        });
//    }
    
    //     ********------UNSOLD MOBILE DATA BY IMEI NO---MANAGEMENT---METHODS------********
    
    //GETTING UNSOLD MOBILE DATA BY IMEI NO
    private void showMobileData_by_IMEI(){
         String imei = imei_input.getText().toUpperCase();
         List<Mobile_DataModel> mobile_DataModels = DBManager.getAllUnSoldMobilesByIMEI(imei);
         
         int count = mobile_DataModels.size();
         
         if(count == 0)
         {
             JOptionPane.showMessageDialog(rootPane, "You have no Mobile Data according to your entered IMEI");
         }
